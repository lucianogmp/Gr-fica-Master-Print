...
export function Vendas() {
  ...
  function imprimirSelecionados() {
    ...
    // Inicia impressão da primeira; as demais são enfileiradas via useEffect
  ...
  if (view === 'lista') return (
    <>
      ...
      <div className="p-6 space-y-6">
        ...
        {algumSelecionado && (
          <div className="flex items-center gap-3 bg-blue-600/10 border border-blue-500/30 rounded-xl px-4 py-3 animate-in fade-in slide-in-from-top-2 duration-200">
        ...
        <div className="bg-[#1f2937] border border-gray-700 rounded-xl overflow-hidden">
          <table className="w-full text-sm">
                ...
                <th className="px-4 py-3 text-center w-10">
                  <button
                    ...
                    style={{
                      ...
                      borderColor: todosSelecionados ? '#2563eb' : undefined,
                    }}
                  >
                    {todosSelecionados && (
            ...
            <tbody>
              {filtradas.length === 0 && (
                <tr><td colSpan={8} className="px-5 py-12 text-center text-gray-600">Nenhuma venda encontrada.</td></tr>
              )}
              {filtradas.map(v => {
